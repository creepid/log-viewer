...
public class BeanConfigFactoryManager implements ConfigBeanTypeResolver {
    ...
    private void initJsonMapper() {
        ...
        module.setDeserializerModifier(new BeanDeserializerModifier() {
            ...
            public JsonDeserializer<?> modifyDeserializer(final DeserializationConfig config,
                ...
                if (ConfiguredBean.class.isAssignableFrom(beanDesc.getBeanClass())) {
                    return new ConfiguredBean.ConfiguredBeanDeserializer(deserializer);
                }
                return deserializer;
            }
        });
        ...
        for (final BeanDefinition bd : scanner.findCandidateComponents("com.github.logviewer")) {
            try {
     ...
     * @param json   the JSON object to serialize config data to
     * @throws ConfigException in case of serialize errors
     */
